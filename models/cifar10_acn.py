...
h0_conv = Convolution2D(96, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(input_drop)
h0_conv = BatchNormalization(axis=1)(h0_conv)
h1_conv = Convolution2D(96, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h0_conv)
h1_conv = BatchNormalization(axis=1)(h1_conv)

# "Pooling" convolution 1
h2_conv = Convolution2D(96, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha), subsample=(2, 2))(h1_conv)
h2_conv = BatchNormalization(axis=1)(h2_conv)
h2_drop = Dropout(0.5)(h2_conv)

h3_conv = Convolution2D(192, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h2_drop)
h3_conv = BatchNormalization(axis=1)(h3_conv)
h4_conv = Convolution2D(192, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h3_conv)
h4_conv = BatchNormalization(axis=1)(h4_conv)

# "Pooling" convolution 2
h5_conv = Convolution2D(192, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha), subsample=(2, 2))(h4_conv)
