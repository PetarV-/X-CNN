...
# Interlayer connections Y <-> U, Y <-> V
Y_to_UV = Convolution2D(96, 1, 1, border_mode='same', activation='relu')(h5_drop_Y)
U_to_Y = Convolution2D(48, 1, 1, border_mode='same', activation='relu')(h5_drop_U)
V_to_Y = Convolution2D(48, 1, 1, border_mode='same', activation='relu')(h5_drop_V)
...
h6_conv_Y = Convolution2D(96, 3, 3, border_mode='same', activation='relu', W_regularizer=l2(alpha))(h5_Y)
