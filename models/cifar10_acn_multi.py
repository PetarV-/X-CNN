...
h5_drop_Y = Dropout(0.5)(h5_conv_Y)
h5_drop_U = Dropout(0.5)(h5_conv_U)
h5_drop_V = Dropout(0.5)(h5_conv_V)

# Interlayer connections Y <-> U, Y <-> V
Y_to_UV = Convolution2D(96, 1, 1, border_mode='same', init='he_uniform', activation='relu')(h5_drop_Y)
U_to_Y = Convolution2D(48, 1, 1, border_mode='same', init='he_uniform', activation='relu')(h5_drop_U)
V_to_Y = Convolution2D(48, 1, 1, border_mode='same', init='he_uniform', activation='relu')(h5_drop_V)

h5_Y = merge([h5_drop_Y, U_to_Y, V_to_Y], mode='concat', concat_axis=1)
h5_U = merge([h5_drop_U, Y_to_UV], mode='concat', concat_axis=1)
h5_V = merge([h5_drop_V, Y_to_UV], mode='concat', concat_axis=1)

# Some more convolutions
h6_conv_Y = Convolution2D(96, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h5_Y)
h6_conv_U = Convolution2D(48, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h5_U)
h6_conv_V = Convolution2D(48, 3, 3, border_mode='same', activation='relu', init='he_uniform', W_regularizer=l2(alpha))(h5_V)
